...
```text
Read AGENTS.md, docs/INDEX.md, HANDOFF.md, and TASKS.md. Verify the handoff
against the current repository state, revision, uncommitted changes, relevant
...
5. Any blocker that should be resolved before implementation
